...
set(SM_VERSION_TRADITIONAL
    "${SM_VERSION_MAJOR}.${SM_VERSION_MINOR}.${SM_VERSION_PATCH}-ViperRev")
...
if(NOT (ret STREQUAL "0"))
  ...
  if(WITH_FULL_RELEASE)
    ...
    set(SM_VERSION_GIT
        "${SM_VERSION_MAJOR}.${SM_VERSION_MINOR}.${SM_VERSION_PATCH}-ViperRev-${SM_VERSION_GIT_HASH}")
  endif()
else()
  if(WITH_FULL_RELEASE)
    set(SM_VERSION_GIT
    ...
    set(SM_VERSION_GIT
        "${SM_VERSION_MAJOR}.${SM_VERSION_MINOR}.${SM_VERSION_PATCH}-ViperRev-git-${SM_VERSION_GIT_HASH}")
  endif()
endif()
